...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 25 mars 2022 à 11:20
...
('DoctrineMigrations\\Version20220325093707', '2022-03-25 09:37:19', 83);
...
CREATE TABLE `films` (
  ...
  `realisateur` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `acteur` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
